      ...
      <td height="350" align="center" valign="top" bgcolor="#C0C0C0">
         <div align="center">
          ...
          <div id="leftnav">
            ...
            <h3>Βήμα 3: Εισάγετε το ιστορικό του Ασθενή<h3><br>

            <div align = "center">

              <form action="addpatientMedical.php" method="POST" "validate();">
                <table width="300" cellspacing="1" border="2" bordercolor="orange" align="center">
                  <tr>
                    <td>
                      ...
                      $query  = "SELECT patientId, patientAmka  FROM patientPersonal WHERE patientId='$_SESSION[patientId]'";
                      $res=mysql_db_query('health_database', $query);
                        ...
                        ?>
                              ...
                              <input type="text" name="patientAllergies" ></br>
                              
                               <font face="verdana" size="2"></br>
                                <b> Πρόγνωση:</b>
                              </font>
                              <input type="text" name="patientPrognosi" ></br></br>

      ...
      <td height="350" align="center" valign="top" bgcolor="#C0C0C0">
         <div align="center">
          ...
          <div id="leftnav">
            ...
            <h3>Βήμα 2: Εισάγετε τις πληροφορίες του Ασθενή<h3><br>

            <div align = "center">

              <form action="addpatientInfo.php" method="POST" "validate();">
                    ...
                    <td>
                      ...
                      $res=mysql_db_query('health_database', $query);
                        ...
                        ?>
                              ...
                              <input type="text" name="patientLast" ></br>
                              
                               <font face="verdana" size="2"></br>
                                <b> Όνομα Ιατρού:</b>
                              </font>
                              <input type="text" name="patientDoctor" ></br></br>
